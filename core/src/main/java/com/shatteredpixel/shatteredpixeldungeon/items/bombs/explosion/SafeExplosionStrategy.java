...
public class SafeExplosionStrategy implements ExplosionStrategy {

    private final int range;

    public SafeExplosionStrategy(int range) {
        this.range = range;
    }
    ...
    public boolean equals(Object o) {
        ...
        SafeExplosionStrategy that = (SafeExplosionStrategy) o;
