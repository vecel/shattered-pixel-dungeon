...
public abstract class KindofMisc extends EquipableItem {
	public KindofMisc() {}
	public KindofMisc(GameLogger logger, DungeonInterface dungeon) {
	...
	public boolean doEquip(final Hero hero) {
		...
		if (equipFull) {
			...
			displayEquipWindow(hero, miscs, enabled);
	...
	protected void displayEquipWindow(Hero hero, KindofMisc[] miscs, boolean[] enabled) {
		GameScene.show(
